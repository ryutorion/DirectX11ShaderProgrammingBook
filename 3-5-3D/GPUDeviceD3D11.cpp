...
{
	uint32_t t = timeGetTime() % 1000;
	float angle = t * 2.0f * std::numbers::pi_v<float> / 1000.0f;

	auto world = DirectX::XMMatrixRotationY(angle);

	auto eye = DirectX::XMVectorSet(0.0f, 3.0f, -5.0f, 1.0f);
